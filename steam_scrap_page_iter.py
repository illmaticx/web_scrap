...
pages = ["https://store.steampowered.com/search/?sort_by=Released_DESC&os=win&filter=popularnew" + "&page=" + str(i) for i in range(1,11)]
...
for page in pages:
	...
	for game in games:
		...
		tag_keys = game["data-ds-tagids"].replace("]","").replace("[","").split(",")
		...
		"Release_Month":game_release_month, "Release_Day":game_release_day,
		"Review_Status":review_status,"Review_Percent":review_percent, 
...
# "Review_Status", "Review_Pop", "Review_Percent", "OS_List","Game_Tags",]]

# print(game_datas.head(10))